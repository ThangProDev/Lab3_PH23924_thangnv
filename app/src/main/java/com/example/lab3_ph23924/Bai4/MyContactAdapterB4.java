...
public class MyContactAdapterB4 extends ArrayAdapter<ContactB4> {
    List<ContactB4> contactList;
    Context context;
    private LayoutInflater mInflater;
    public MyContactAdapterB4(Context context, List<ContactB4> objects) {
    ...
    @Override
    public ContactB4 getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ContactB4 item = getItem(position);
